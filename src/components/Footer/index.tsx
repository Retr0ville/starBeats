      ...
      <div className="tw-bg-black">
        <div className="">
          <section className="ssm:tw-flex ssm:tw-flex-col ssm:tw-items-center ssm:tw-py-20 ssm:tw-px-6 tw-py-7 tw-px-6 tw-border-b-[#ffffff1f] tw-border-b-[1px] tw-border-solid">
            ...
            <div>
              <form action="POST" className="ssm:tw-max-w-[484px] ssm:tw-flex-row 2md:tw-w-[484px] ssm:tw-items-stretch ssm:tw-p-2 ssm:tw-bg-[#282828] ssm:tw-rounded-[5px] tw-flex tw-flex-col tw-items-center ">
